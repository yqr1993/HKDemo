...
* 
* File   name��ConfigParams.cpp
* Discription��
* Version    ��1.0
* Author     ��panyadong
* Create Date��2010_3_29
...
int Demo_CompressParams()
{
    ...
    iRet = NET_DVR_GetDVRConfig(lUserID, NET_DVR_GET_COMPRESSCFG, struDeviceInfoV40.struDeviceV30.byStartChan, \
    ...
    iRet = NET_DVR_SetDVRConfig(lUserID, NET_DVR_SET_COMPRESSCFG, struDeviceInfoV40.struDeviceV30.byStartChan, \
...
int Demo_PictureParams(LONG lUserID)
{
    ...
    //2.modify
	struParams.dwSize = sizeof(NET_DVR_PICCFG_V30);
    strcpy((char *)(struParams.sChanName), "��������");
